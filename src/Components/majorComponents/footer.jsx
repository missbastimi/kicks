...
return (
    <footer className="bg-[#E7E7E3] relative bottom-0 flex flex-col w-[1320px] h-[931px] text-white px-6 py-8">
        {/* blue */}
        <div className="relative w-[1320px] h-[545px] rounded-[48px] bg-[#4A69E3]">
            <div className="absolute flex flex-col w-[510px] h-[237px] top-[64px] left-[72px] gap-[32px]">
  ...
  <p className="w-[354px] h-[27px] font-openSans font-semibold text-[20px] leading-[100%] tracking-[0px] text-[#E7E7E3] ">Sign up for free! Join the community.</p>
                ...
                <div className="flex  w-[448px] h-[48px] gap-[4px]">
                    <input type="text" placeholder="Enter your email" className="w-[342px] h-[48px] rounded-[8px] px-[16px] py-[12px] text-black text-[16px] leading-[100%] tracking-normal font-openSans font-medium" />
                    <button
  ...
  >
    Subscribe
        ...
        {/* black */}
        <div className="absolute w-[1320px] h-[591px] rounded-[48px] bg-[#232321] bottom-0 overflow-hidden" >
